...
public class NotesTest {
	...
	public void test() {
		...
		WebElement ClickOnRem = driver.findElementById("com.sheikbro.onlinechat:id/audio");
		ClickOnRem.click();
		
		WebElement RemName = driver.findElementById("com.sheikbro.onlinechat:id/note");
		RemName.click();
		String rem = sc.nextLine();
		RemName.sendKeys(rem);
		
		WebElement ClickonSet = driver.findElementById("com.sheikbro.onlinechat:id/dialogButtonOK");
		ClickonSet.click();
