...
public class Logout {
	...
	public void clickSignIn() {
		...
		waitone.until(ExpectedConditions.presenceOfElementLocated(By.id("com.sheikbro.onlinechat:id/myaccc")));

		WebElement myAccountone = driver.findElementById("com.sheikbro.onlinechat:id/myaccc") ;
		myAccountone.click();
				
		WebElement logout = driver.findElementById("com.sheikbro.onlinechat:id/logout");
		logout.click();
